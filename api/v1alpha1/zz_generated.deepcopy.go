...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SubnetTagRule) DeepCopyInto(out *SubnetTagRule) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SubnetTagRule.
func (in *SubnetTagRule) DeepCopy() *SubnetTagRule {
	if in == nil {
		return nil
	}
	out := new(SubnetTagRule)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TagRule) DeepCopyInto(out *TagRule) {
	*out = *in
	if in.SubnetTagRules != nil {
		in, out := &in.SubnetTagRules, &out.SubnetTagRules
		*out = make([]SubnetTagRule, len(*in))
		copy(*out, *in)
	}
}
