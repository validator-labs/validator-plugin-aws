...
func (in *AccessKeyPair) DeepCopyInto(out *AccessKeyPair) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AccessKeyPair.
func (in *AccessKeyPair) DeepCopy() *AccessKeyPair {
	if in == nil {
		return nil
	}
	out := new(AccessKeyPair)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AwsAuth) DeepCopyInto(out *AwsAuth) {
	*out = *in
	if in.AccessKeyPair != nil {
		in, out := &in.AccessKeyPair, &out.AccessKeyPair
		*out = new(AccessKeyPair)
		**out = **in
	}
	if in.StsAuth != nil {
...
func (in *AwsValidatorSpec) DeepCopyInto(out *AwsValidatorSpec) {
	*out = *in
	...
	if in.AmiRules != nil {
		in, out := &in.AmiRules, &out.AmiRules
		*out = make([]AmiRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
